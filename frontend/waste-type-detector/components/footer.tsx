    ...
    <footer className="w-full border-t border-gray-100 bg-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-sm text-gray-500">
          &copy; 2025 Eco-Scan Detector. All rights reserved.
        </p>

        {/* Lado Direito: Créditos do Dev */}
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <a 
            ...
            className="flex items-center gap-1 font-medium text-emerald-600 hover:text-emerald-700 transition-colors"
          >
            imrooteodoro
            {/* Ícone Github pequeno */}
